		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					action { //it:State
						...
						coap.actorQakSonarCoapObserver.activate(myself)
				...
				state("accept") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="clientMsg5",targetState="handleClientRequest",cond=whenRequest("clientRequest"))
					transition(edgeName="clientMsg6",targetState="handleCarEnter",cond=whenRequest("carenter"))
					transition(edgeName="clientMsg7",targetState="handleClientOut",cond=whenDispatchGuarded("outTokenid",{ coap.actorQakSonarCoapObserver.readResponse()=="free"  
					}))
				}	 
				...
				state("handleCarEnter") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t38",targetState="moveTrolleyHome",cond=whenTimeout("local_tout_parkmanagerservice_handleCarEnter"))   
					transition(edgeName="t39",targetState="handleClientRequest",cond=whenRequest("clientRequest"))
					transition(edgeName="t310",targetState="handleCarEnter",cond=whenRequest("carenter"))
					transition(edgeName="t311",targetState="handleClientOut",cond=whenDispatchGuarded("outTokenid",{ coap.actorQakSonarCoapObserver.readResponse()=="free"  
					}))
				}	 
				state("handleClientOut") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t412",targetState="moveTrolleyHome",cond=whenTimeout("local_tout_parkmanagerservice_handleClientOut"))   
					transition(edgeName="t413",targetState="handleClientRequest",cond=whenRequest("clientRequest"))
					transition(edgeName="t414",targetState="handleCarEnter",cond=whenRequest("carenter"))
					transition(edgeName="t415",targetState="handleClientOut",cond=whenDispatchGuarded("outTokenid",{ coap.actorQakSonarCoapObserver.readResponse()=="free"  
					}))
				}	 
