		...
		return { //this:ActionBasciFsm
				...
				state("wMove") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t018",targetState="stepDone",cond=whenReply("stepdone"))
					transition(edgeName="t019",targetState="stepFailed",cond=whenReply("stepfail"))
				}	 
				...
				state("parkthecar") { //this:State
					action { //it:State
						...
						if(  ! itunibo.planner.plannerUtil.atPos(x.toInt(),y.toInt())  
						 ...
						 updateResourceRep( "pos" + itunibo.planner.plannerUtil.get_curPos().toString()  
						 )
						 }
					}
				...
				state("stepFailed") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t120",targetState="stepDone",cond=whenReply("stepdone"))
					transition(edgeName="t121",targetState="stepFailed",cond=whenReply("stepfail"))
				}	 
			}
		}
}
