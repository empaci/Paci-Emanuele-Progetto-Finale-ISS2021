	...
	override fun getBody() : (ActorBasicFsm.() -> Unit){
		...
		return { //this:ActionBasciFsm
				...
				state("accept") { //this:State
					...
					transition(edgeName="clientMsg2",targetState="handleClientOut",cond=whenDispatchGuarded("outTokenid",{ coap.actorQakSonarCoapObserver.readResponse()=="free"  
					}))
				}	 
				...
				state("handleCarEnter") { //this:State
					...
					transition(edgeName="t36",targetState="handleClientOut",cond=whenDispatchGuarded("outTokenid",{ coap.actorQakSonarCoapObserver.readResponse()=="free"  
					}))
				}	 
				state("handleClientOut") { //this:State
					...
					transition(edgeName="t410",targetState="handleClientOut",cond=whenDispatchGuarded("outTokenid",{ coap.actorQakSonarCoapObserver.readResponse()=="free"  
					}))
				}	 
